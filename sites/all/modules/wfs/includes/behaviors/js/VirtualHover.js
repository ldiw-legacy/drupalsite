...
/**
 * Class: OpenLayers.Control.VirtualHover
 * <OpenLayers.Layer.VirtualHover> constructor.
 *
 * Inherits from:
 *  - <OpenLayers.Layer>
 */
OpenLayers.Control.VirtualHover = OpenLayers.Class(OpenLayers.Control, { 
    /**
     * TODO: eliminate this constant
     */
    EVENT_TYPES: ['mouseover'],
    ...
    initialize: function(layer, map, options) {
        ...
        this.layer.events.register('loadend', this, this.flushCache);
    },
     ...
     */
    onMove: function(evt) {
      // clear the onPause timeout entirely
    }
});
