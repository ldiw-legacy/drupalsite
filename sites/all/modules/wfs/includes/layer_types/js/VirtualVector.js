...
/**
 * Class: OpenLayers.Layer.VirtualVector
 * Instances of OpenLayers.Layer.VirtualVector are used to simulate
 * map interaction with an OpenLayers.Layer.Vector layer without 
 * invoking any browser rendering. VirtualVector is meant to be used 
 * in conjunction with VirtualHover to provide interaction.
 * Create a new virtual vector layer with the
 *     <OpenLayers.Layer.VirtualVector> constructor.
 *
 * Inherits from:
 *  - <OpenLayers.Layer>
 */
OpenLayers.Layer.VirtualVector = OpenLayers.Class(OpenLayers.Layer, {
    ...
    clone: function (obj) {
        ...
        if (obj == null) {
            obj = new OpenLayers.Layer.VirtualVector(this.name, this.getOptions());
        }
    ...
    CLASS_NAME: "OpenLayers.Layer.VirtualVector"
});
